...
import TypeModule (Criterion(..), WeightedCriterions)
...
blindtext1Naturalism :: [(Criterion, Double)] -> Double
blindtext1Naturalism evaluables = naturalism evaluables blindtext1
...
cosutmCriteria :: WeightedCriterions
cosutmCriteria =	[ (Monogram		, 100)
					--, (Bigram		, 0)
					--, (Trigram		, 0)
					--, (Quadrigram	, 0)
					--, (Word			, 0)
