module BlindtextModule (blindtext1, blindtext1Norm, cryptotext1, cryptotext2) where
...
main = do
	print "Naturalism of Cleartext:"
	print . naturalism $ blindtext1
	print "Naturalism of Kryptotext1:"
	print . naturalism $ cryptotext1
	print "Naturalism of Kryptotext2:"
	print . naturalism $ cryptotext2
